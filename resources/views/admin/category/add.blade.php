...
@section('content')
    ...
    <div class="box-body big">
        ...
        <h3 class="form-title">Category</h3>
        ...
        <form role="form" action="{{route('admin.category.add')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <label class="radio-inline"> <input type="radio" class="uniform" name="status" value="{{\App\Category::$status_value['Active']}}" checked> Active </label>
                    <label class="radio-inline"> <input type="radio" class="uniform" name="status" value="{{\App\Category::$status_value['DeActive']}}"> DeActive </label>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <label class="radio-inline"> <input type="radio" class="uniform" name="theme" value="{{\App\Category::$theme_value['Light']}}" checked> Light </label>
                    <label class="radio-inline"> <input type="radio" class="uniform" name="theme" value="{{\App\Category::$theme_value['Blue']}}"> Blue </label>
