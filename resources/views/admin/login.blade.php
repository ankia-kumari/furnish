...
<head>
    ...
    <!-- STYLESHEETS --><!--[if lt IE 9]><script src="{{asset('assets/js/flot/excanvas.min.js')}}"></script><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><script src="http://css3-mediaqueries-js.googlecode.com/svn/trunk/css3-mediaqueries.js"></script><![endif]-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div id="logo">
                        <a href="index.html"><img src="{{asset('assets/img/logo/logo-alt.png')}}" height="40" alt="logo name" /></a>
                    </div>
                </div>
            </div>
        </div>
