...
@section('content')
    ...
    <div class="box-body big">
        ...
        <form role="form" action="{{route('admin.slider.add')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <label class="radio-inline"> <input type="radio" class="uniform" name="status" value="{{\App\Slider::$status_value['Active']}}" checked> Active </label>
                    <label class="radio-inline"> <input type="radio" class="uniform" name="status" value="{{\App\Slider::$status_value['DeActive']}}"> DeActive </label>
